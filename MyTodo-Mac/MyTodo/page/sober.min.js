...
`,props:{size:"medium",extended:!1},propSyncs:!0,setup(){let t;return{watches:{extended:e=>t.setAttribute("centered",String(!e))},render:()=>d`
        ...
        <slot></slot>
        <slot name="end"></slot>
      `}}}){}T.define();class q extends e({name:"s-icon-button",style:`
:host{
  display: inline-flex;
  vertical-align: middle;
  justify-content: center;
...
`,props:{type:"none"},propSyncs:["type"],setup(){let o;return{watches:{type:e=>{let t=C[e];"object"==typeof t?(o.setAttribute("transform",`rotate(${t.angle} 480 -480)`),t=C[t.name]):o.removeAttribute("transform"),o.setAttribute("d",t)}},render:()=>d`
        <slot>
          <svg viewBox="0 -960 960 960">
            <path ref="${e=>o=e}" d="${C.none}"></path>
          </svg>
        </slot>
      `}}}){}L.define();class z extends e({name:"s-linear-progress",style:`
:host{
  display: block;
  height: 4px;
  color: var(--s-color-primary, #006495);
...
`,props:{indeterminate:!1,max:100,value:0},propSyncs:["indeterminate"],setup(){let t;var e=()=>{var e=Math.min(this.value,this.max)/this.max*100;t.style.transform=`translateX(-${100-e}%)`};return{watches:{max:e,value:e},render:()=>d`
      ...
      `}}}){}z.define();class S extends e({name:"s-menu",style:`
:host{
  display: inline-block;
  vertical-align: middle;
  font-size: .875rem;
...
`,props:{group:""},propSyncs:["group"],setup(){let t;const e=e=>t.show(e),o=()=>t.dismiss();return this.addEventListener("menu-item:click",e=>{e.stopPropagation(),o()}),{mounted:()=>{this.parentNode instanceof S&&t.setAttribute("align","right")},expose:{show:e,dismiss:o,toggle:e=>t.toggle(e)},render:()=>d`
      ...
      `}}}){}class A extends e({name:"s-menu-item",style:`
:host{
  display: block;
  height: 44px;
}
...
`,props:{},setup(){const e=()=>{this.dispatchEvent(new Event("menu-item:click",{bubbles:!0}))};return{render:()=>d`
      ...
      `}}}){}S.define(),A.define();class N extends e({name:"s-navigation",style:`
:host{
  display: flex;
  justify-content: center;
  align-items: center;
...
`,props:{mode:"bottom"},propSyncs:!0,setup(){let r=[],n=-1,t=!1;return this.addEventListener("navigation-item:change",e=>{if(e.stopPropagation(),!t&&(t=!0,e.target)){const o=e.target;n=-1,r.forEach((e,t)=>{if(e===o&&o.checked)return n=t;e.checked&&(e.checked=!1)}),t=!1,this.dispatchEvent(new Event("change"))}}),{expose:{get options(){return r},get selectIndex(){return n}},render:()=>d`
        <slot name="start"></slot>
        <slot @slotchange="${(e,t)=>{r=t.assignedElements().filter(e=>e instanceof Z),n=r.findIndex(e=>e.checked)}}"></slot>
        <slot name="end"></slot>
...
`,props:{checked:!1},propSyncs:!0,setup(){return this.addEventListener("click",()=>this.checked=!0),{watches:{checked:()=>{this.parentNode&&this.dispatchEvent(new Event("navigation-item:change",{bubbles:!0}))}},render:()=>d`
        <div class="icon">
          <slot name="icon"></slot>
        </div>
        <slot name="text"></slot>
...
`,props:{readonly:!1,max:10,min:0,value:5,step:1},propSyncs:["readonly"],setup(){let t,o;const r=()=>{var e=100*(Number(o.value)-this.min)/this.max-this.min;t.style.width=e+"%"};return{watches:{max:e=>{e=String(e);o.max!==e&&(o.max=e,r())},min:e=>{e=String(e);o.min!==e&&(o.min=e,r())},step:e=>{e=String(e);o.step!==e&&(o.step=e,r())},value:e=>{e=String(e);o.value!==e&&(o.value=e,r())}},render:()=>d`
        ...
        />
      `}}}){}I.define();class P extends e({name:"s-search",style:`
:host{
  display: inline-flex;
  vertical-align: middle;
  max-width: 520px;
...
`,props:{size:"medium"},propSyncs:!0,setup(){return{render:()=>d`
      ...
      `}}}){}P.define();class X extends e({name:"s-segmented-button",style:`
:host{
  display: inline-flex;
  align-items: center;
  vertical-align: middle;
...
`,props:{},setup(){let r=[],n=-1,t=!1;return this.addEventListener("segmented-button-item:change",e=>{if(e.stopPropagation(),!t&&(t=!0,e.target)){const o=e.target;n=-1,r.forEach((e,t)=>{if(e===o&&o.checked)return n=t;e.checked&&(e.checked=!1)}),t=!1,this.dispatchEvent(new Event("change"))}}),{expose:{get options(){return r},get selectIndex(){return n}},render:()=>d`
        <slot @slotchange="${(e,t)=>{r=t.assignedElements().filter(e=>e instanceof H),n=r.findIndex(e=>e.checked)}}"></slot>
      `}}}){}class H extends e({name:"s-segmented-button-item",style:`
:host{
  flex-basis: 100%;
  display: flex;
  justify-content: center;
...
`,props:{checked:!1,disabled:!1,selectable:!0},propSyncs:["checked","disabled"],setup(){return this.addEventListener("click",()=>this.selectable&&(this.checked=!0)),{watches:{checked:()=>{this.parentNode&&this.dispatchEvent(new Event("segmented-button-item:change",{bubbles:!0}))}},render:()=>d`
        <slot name="start"></slot>
        <slot></slot>
        <slot name="end"></slot>
        <s-ripple class="ripple" attached="true"></s-ripple>
      `}}}){}X.define(),H.define();class O extends e({name:"s-slider",style:`
:host{
  display: block;
  color: var(--s-color-primary, #006495);
  height: 40px;
...
`,props:{disabled:!1,labeled:!1,max:100,min:0,step:1,value:50},propSyncs:["disabled","labeled"],setup(){let t,o,r,n;const s=()=>{var e=100-(100*(Number(r.value)-this.min)/this.max-this.min);t.style.transform=`translateX(-${e}%)`,o.style.transform=`translateX(calc(-${e}% + ${.4*e}px))`,this.value=Number(r.value),n.textContent=r.value};return{watches:{max:e=>{e=String(e);r.max!==e&&(r.max=e,s())},min:e=>{e=String(e);r.min!==e&&(r.min=e,s())},step:e=>{e=String(e);r.step!==e&&(r.step=e,s())},value:e=>{e=String(e);r.value!==e&&(r.value=e,s())}},render:()=>d`
        ...
        />
      `}}}){}O.define();class _ extends e({name:"s-snackbar",style:`
:host{
  display: inline-flex;
  vertical-align: middle;
}
...
`,props:{duration:5e3},setup(t){let o;const r={timer:0},e=()=>{var e=c(t);0===e.top&&0===e.left||o.setAttribute("style",`width: ${innerWidth}px;height: ${innerHeight}px;top: ${0-e.top}px;left: ${0-e.left}px`),clearTimeout(r.timer),getComputedStyle(o).top,o.classList.add("show"),this.dispatchEvent(new Event("show")),0<this.duration&&(r.timer=setTimeout(n,this.duration))},n=()=>{clearTimeout(r.timer),o.classList.remove("show"),this.dispatchEvent(new Event("dismiss"))},s=e=>{"transform"===e.propertyName&&(e=o.classList.contains("show"),this.dispatchEvent(new Event(e?"showed":"dismissed")))};return{expose:{show:e,dismiss:n},render:()=>d`
      ...
      `}}}){static show=e=>{let t=document.body;const o=new _;var r=document.body.firstElementChild;r&&"S-PAGE"===r.tagName&&(t=r),"string"==typeof e?o.textContent=e:(e.root&&(t=e.root),o.textContent=e.text,e.action&&((r=document.createElement("s-button")).type="text",r.slot="action",r.textContent=e.action.text,e.action.click&&r.addEventListener("click",e.action.click),o.appendChild(r)),e.duration&&(o.duration=e.duration)),t.appendChild(o),o.addEventListener("dismissed",()=>t.removeChild(o)),o.show()}}_.define();class R extends e({name:"s-switch",style:`
:host{
  display: inline-flex;
  vertical-align: middle;
  align-items: center;
...
`,props:{disabled:!1,checked:!1},propSyncs:!0,setup(){return this.addEventListener("click",()=>{this.checked=!this.checked,this.dispatchEvent(new Event("change"))}),{render:()=>d`
      ...
      `}}}){}R.define();class D extends e({name:"s-tab",style:`
:host{
  display: flex;
  justify-content: center;
  position: relative;
...
`,props:{mode:"scrollable"},propSyncs:["mode"],setup(){let s,i=[],a=-1,l=!1;return this.addEventListener("tab-item:change",e=>{if(e.stopPropagation(),!l&&(l=!0,e.target)){const o=e.target,r=i[a],n=(a=-1,i.forEach((e,t)=>{if(e===o&&o.checked)return a=t;e.checked&&(e.checked=!1)}),l=!1,i[a]);var t;this.isConnected&&r&&n&&(n.indicator.setAttribute("style","transition:none;filter:opacity(0)"),r.indicator.addEventListener("transitionend",()=>{n.indicator.addEventListener("transitionend",()=>r.indicator.setAttribute("style","visibility:hidden"),{once:!0}),n.indicator.removeAttribute("style")},{once:!0}),e=r.indicator.getBoundingClientRect().left,t=n.indicator.getBoundingClientRect(),r.indicator.setAttribute("style",`filter:opacity(1);transform:translateX(${t.left-e}px);width: ${t.width}px`),s.scrollWidth!==s.offsetWidth)&&(e=n.offsetLeft-s.offsetWidth+s.offsetWidth/2+n.offsetWidth/2,s.scrollTo({left:e,behavior:"smooth"})),this.dispatchEvent(new Event("change"))}}),{expose:{get options(){return i},get selectIndex(){return a}},render:()=>d`
        <div class="container" ref="${e=>s=e}">
          <slot @slotchange="${(e,t)=>{i=t.assignedElements().filter(e=>e instanceof j),a=i.findIndex(e=>e.checked)}}"></slot>
        </div>
      `}}}){}class j extends e({name:"s-tab-item",style:`
:host{
  display: flex;
  align-items: center;
  justify-content: center;
...
`,props:{checked:!1},propSyncs:!0,setup(){let t,o,r;return this.addEventListener("click",()=>this.checked=!0),{expose:{get indicator(){return r}},watches:{checked:()=>{this.parentNode&&this.dispatchEvent(new Event("tab-item:change",{bubbles:!0}))}},render:()=>d`
        <div class="container" ref="${e=>o=e}">
          <slot name="icon" ref="${e=>t=e}" @slotchange="${()=>{var e=t.assignedElements().length;o.classList[0<e?"add":"remove"]("icon")}}"></slot>
          <div class="text">
            <slot name="text"></slot>
            <div class="badge">
              <slot name="badge"></slot>
          ...
          <div class="indicator" ref="${e=>r=e}"></div>
        </div>
        <s-ripple attached="true"></s-ripple>
      `}}}){}D.define(),j.define();class Y extends e({name:"s-table",style:`
:host{
  display: block;
  font-size: .875rem;
  border: solid 1px var(--s-color-outline-variant, #c1c7ce);
...
`,props:{},setup(){return{render:()=>d`
      ...
      `}}}){}return ee.define(),Object.freeze({__proto__:null,Badge:t,Button:i,Card:a,Carousel:v,Checkbox:x,Chip:g,CircularProgress:b,Dialog:w,Divider:k,Drawer:$,Dropdown:E,FAB:T,Icon:L,IconButton:q,LinearProgress:z,Menu:S,MenuItem:A,Navigation:N,NavigationItem:Z,Page:B,RadioButton:W,Rate:I,Ripple:s,ScrollView:y,Search:P,SegmentedButton:X,SegmentedButtonItem:H,Slider:O,Snackbar:_,Switch:R,Tab:D,TabItem:j,Table:Y,Tbody:G,Td:J,TextField:K,Th:V,Thead:F,Tooltip:U,TopAppBar:ee,Tr:Q})});
